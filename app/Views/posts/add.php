        ...
        <div class="options my-4 row w-100 h-auto">
            <div class="filter row justify-content-start">
                <div class="column rounded shadow">
                    <input class="d-none" type="checkbox" name="filter" id="mask" value="mask" onclick="choose_filter()">
		  			<label for="mask"><img src="../public/img/mask.png" class="filter_img my-auto"></label>
                </div>
                <div class="column rounder shadow ">
                    <input class="d-none" type="checkbox" name="filter" id="covid" value="covid" onclick="choose_filter()">
                    <label for="covid"><img src="../public/img/covid.png" class="filter_img"></label>
                </div>
                <div class="column rounded shadow">
                    <input class="d-none" type="checkbox" name="filter" id="ball" value="ball" onclick="choose_filter()">
		  			<label for="ball"><img src="../public/img/ball.png" class="filter_img"></label>
                </div>
                <div class="column rounded shadow">
                    <input class="d-none" type="checkbox" name="filter" id="hat" value="hat" onclick="choose_filter()">
    ...
    <?php $i = 0; foreach($data['posts'] as $post) : if ($i++ < 5) :
            if($post->userId == $_SESSION['user_id']): ?>
                <div class="rounded" id="add-gallery">
                    <div class="imgs mx-1">
                        <img class="add-img rounded mb-1 shadow" src="<?php echo $post->content; ?>" alt="<?php echo $post->title; ?>">
                        <div class="btn-delete w-100 h-auto">
                            <a href="<?php echo URL_ROOT; ?>/posts/del_post/<?php echo $post->postId ?>/2"><input type="submit" value="Delete" name="delete" class=" btn btn-outline-danger shadow h-auto"></a>
                        </div>
                    </div>
                </div>
